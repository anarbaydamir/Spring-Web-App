...
//@Transactional //transaction emeliyyatlarini springin yerine yetirmesi uchun bu annotationdan istifade olunur.
public class UserRepositoryCustomImpl implements UserRepositoryCustom {
   ...
   // @Cacheable(value = "users")
    ...
    @Override
   // @CacheEvict(value = "users",allEntries = true) //yadda qalinan cachei silir
